				...
				<div class="col-md-12 col-md-offset-0 text-left">
					<div class="row row-mt-15em">
						...
						<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
							...
							<h1>Une question, un conseil, un projet n'hésitez pas à nous contacter.</h1>	
						</div>
					...
					<form action="#">
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<textarea name="message" id="message" cols="30" rows="10" class="form-control" placeholder="Ecrivez votre message ici ..."></textarea>
							</div>
						</div>
						<div class="form-group">
							<input name="envoyer" type="submit" value="Envoyer" class="btn btn-primary">
						</div>
